...
import { Container, Header, Content, List, ListItem, Text, Separator ,Title,Icon,Right,Left,Button,Body} from 'native-base';
export default class Electoral extends Component {
